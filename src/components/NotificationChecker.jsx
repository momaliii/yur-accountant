...
export default function NotificationChecker() {
  const { debts, expenses, goals, income, savings, processRecurringExpenses } = useDataStore();
  ...
  useEffect(() => {
    ...
    // Reset notification flags daily at midnight and process recurring expenses
    const resetDaily = () => {
      const now = new Date();
      ...
      setTimeout(async () => {
        ...
        // Process recurring expenses at midnight to create new monthly entries
  ...
  }, [debts, expenses, goals, income, savings, notificationsEnabled, notificationPermission, baseCurrency, exchangeRates, processRecurringExpenses]);
